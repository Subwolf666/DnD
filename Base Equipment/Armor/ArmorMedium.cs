...
namespace Base_Equipment {
    public class ArmorMedium : ArmorType {

        private const int MEDIUMARMOR_ID_HIDE = 1;
        private const int MEDIUMARMOR_ID_CHAINSHIRT = 2;
        private const int MEDIUMARMOR_ID_SCALEMAIL = 3;
        private const int MEDIUMARMOR_ID_BREASTPLATE = 4;
        private const int MEDIUMARMOR_ID_HALFPLATE = 5;
        ...
        public ArmorType[] PopulateMediumArmor() {
            var MediumArmors = new ArmorType[] {
                new ArmorType(MEDIUMARMOR_ID_HIDE, "Hide", "This crude armor consists of thick furs and " +
                ...
                new ArmorType(MEDIUMARMOR_ID_CHAINSHIRT, "Chain shirt", "Made of interlocking metal rings, a chain " +
                ...
                new ArmorType(MEDIUMARMOR_ID_SCALEMAIL, "Scale mail", "This armor consists of a coat and leggings " +
                ...
                new ArmorType(MEDIUMARMOR_ID_BREASTPLATE, "Breastplate", "This armor consists of a fitted metal " +
                ...
                new ArmorType(MEDIUMARMOR_ID_HALFPLATE, "Half plate", "Half plate consists of shaped metal plates " +
