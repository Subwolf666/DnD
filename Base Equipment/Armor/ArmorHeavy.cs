...
namespace Base_Equipment {
    public class ArmorHeavy {

        public ArmorHeavy() { }

        public ArmorType[] PopulateHeavyArmor() {
            var HeavyArmors = new ArmorType[] {
                //new ArmorType((int)Enums.HeavyArmorTypes.HEAVYARMOR_ID_RINGMAIL, "Ring mail", "This armor is leather armor with heavy " +
                ...
                //new ArmorType((int)Enums.HeavyArmorTypes.HEAVYARMOR_ID_CHAINMAIL, "Chain mail", "Made of interlocking metal rings, chain " +
                ...
                //new ArmorType((int)Enums.HeavyArmorTypes.HEAVYARMOR_ID_SPLINT, "Splint", "This armor is made of narrow vertical strips " +
                ...
                //new ArmorType((int)Enums.HeavyArmorTypes.HEAVYARMOR_ID_PLATE, "Plate", "Plate consists of shaped, interlocking metal " +
