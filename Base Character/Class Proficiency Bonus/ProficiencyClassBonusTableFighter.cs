...
namespace Base_Character {
    public class ProficiencyClassBonusTableFighter : ProficiencyClassBonusTable {

        public ProficiencyClassBonusTableFighter() { }

        public ProficiencyClassBonusTable[] PopulateProficiencyClassBonusTableFighter() {
